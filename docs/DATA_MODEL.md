...
`User` and `UserSettings` were implemented during Phase 2. `Habit` was implemented during Phase 3 through a C# entity, enums, Entity Framework Core configuration, a PostgreSQL migration, indexes, a foreign key, and database check constraints. The remaining MVP entities are planned for their later phases.
...
The Phase 2 authentication migration created the user and settings schema. The Phase 3 habit migration added the habit schema.
...
### Implemented Phase 2 and Phase 3 Constraints
